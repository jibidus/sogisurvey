...
val CRITERIA = listOf(
    ...
    CriterionInput(
        id = "duree-mission", title = "⏱️ Durée de mission",
    ...
    CriterionInput(
        id = "domaine-metier", title = "🏙️ Domaine métier",
        commentPlaceholder = "Ex: médical, éthique, IA…"
    ),
    CriterionInput(
        id = "autonomie", title = "⛵️ Autonomie pour adresser les besoins exprimés",
        commentPlaceholder = "Plus de précision…"
    ),
    CriterionInput(
        id = "progression", title = "🏃‍♀️ La mission me fait progresser rapidement",
